...
run function spellbook:crafting/craft_common_ink {loot:"spellbook:item/common_ink"}
...
run function spellbook:crafting/craft_uncommon_ink {loot:"spellbook:item/uncommon_ink"}
...
run function spellbook:crafting/craft_rare_ink {loot:"spellbook:item/rare_ink"}
